...
var program = require('commander')
    ...
    .option('--scripts-version <alternative-package>', 'use a non-standard version of Inferno-scripts')
    .on('--help', function () {
        console.log('    Only ' + chalk.green('<project-directory>') + ' is required.');
        console.log();
        console.log('    A custom ' + chalk.cyan('--scripts-version') + ' can be one of:');
        console.log('      - a specific npm version: ' + chalk.green('0.8.2'));
        console.log('      - a custom fork published on npm: ' + chalk.green('my-Inferno-scripts'));
        console.log('      - a .tgz archive: ' + chalk.green('https://mysite.com/my-Inferno-scripts-0.8.2.tgz'));
...
if (typeof projectName === 'undefined') {
    ...
    console.log('  ' + chalk.cyan(program.name()) + chalk.green(' my-Inferno-app'));
    console.log();
...
function createApp(name, verbose, version) {
    ...
    console.log(
        'Creating a new Inferno app in ' + chalk.green(root) + '.'
    );
    console.log();
    ...
    console.log('Installing ' + chalk.cyan('Inferno-scripts') + '...');
    console.log();
