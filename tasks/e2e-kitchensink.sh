...
then
  ...
  #    https://github.com/facebookincubator/create-inferno-app/pull/2400
  # When removing workaround, you may run into
  #    https://github.com/facebookincubator/create-inferno-app/issues/2030
  case "$(uname -s)" in
...
# of inferno-dev-utils and not inferno-scripts
npm link "$root_path"/packages/inferno-error-overlay
...
npm unlink "$root_path"/packages/inferno-error-overlay
